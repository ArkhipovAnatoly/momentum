...
let widgets = ['player', 'weather', 'quote', 'date', 'time', 'greeting', 'switch-player'];
let isFocused = false;
...
function settingsLangToogle() {
    settingsMenuTitle.textContent = currentLanguage == 'RU' ? translate('Settings') : 'Settings';
    settingsMenuSubtitle.textContent = currentLanguage == 'RU' ? translate('General') : 'General';
    langSetting.textContent = currentLanguage == 'RU' ? translate('Language') : 'Language';
    imageSourceSetting.textContent = currentLanguage == 'RU' ? translate('Image source') : 'Image source';
    iTag.textContent = currentLanguage == 'RU' ? translate('Image tag') : 'Image tag';
    widgetsSubtitle.textContent = currentLanguage == 'RU' ? translate('Widgets') : 'Widgets';
    greetingSetting.textContent = currentLanguage == 'RU' ? translate('Greeting') : 'Greeting';
    timeSetting.textContent = currentLanguage == 'RU' ? translate('Time') : 'Time';
    dateSetting.textContent = currentLanguage == 'RU' ? translate('Date') : 'Date';
    quotesSetting.textContent = weatherSetting.textContent = currentLanguage == 'RU' ? translate('Quotes') : 'Quotes';
    weatherSetting.textContent = currentLanguage == 'RU' ? translate('Weather') : 'Weather';
    playerSetting.textContent = currentLanguage == 'RU' ? translate('Audio player') : 'Audio player';
    playerViewSetting.textContent = currentLanguage == 'RU' ? translate('Extended player') : 'Extended player';
}
...
export default function appSettings() {
    ...
    window.addEventListener('load', () => {
        ...
        if (valueSourceAPI != '') {
            ...
            if (currentImageSource == 'Unsplash API' || currentImageSource == 'Flickr API') {
                tag.classList.add('visible');
            } else {
                tag.classList.remove('visible');
            }
